...
func (client *Client) Init(config *openapiutil.Config) (err error) {
	...
	client.Endpoint, err = client.GetEndpoint(dara.String("vpc"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if err != nil {
		return err
	}
